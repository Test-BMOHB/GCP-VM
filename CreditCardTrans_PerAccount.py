...
#Date         : 2015-12-10
#Program Name : Credit Card Transactions Scenario - Advance Payments
#Version#     :1
#Description  : Code that generates debit and credit transactions, as well as over-payments for cash advances ML scenarios
...
with open('CreditCardTrans_PerAccount.csv','w') as f1:
	...
	for i in range(100):
			...
			usedAmt = 0
			#loop to generate 50 transactions per customer, we can add a random number generator to avoid the constant value
			for j in range(50):
				dt = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
				#generate amount for current transaction with 40%-60% distribution on credits and debits
				...
				#pull value from dictionary for ran=ndomly selected mercant category f
