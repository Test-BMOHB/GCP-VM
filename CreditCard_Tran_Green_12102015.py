...
#Green Transactions are defined by Merchant Category, Transaction Types and Country.
#Merchant Category is divided into three risk categories per senor Kamin's best judgement. As a reference we used MCC (Merchant Category Codes)
...
with open('CreditCard_Transaction_Green.csv','w') as f1: 

    writer=csv.writer(f1, delimiter=',',lineterminator='\n',)
    writer.writerow(['rownum'] +['Account_Number'] + ['Merchant_Name']+['Merchant_Category_Code']+['Merchant_Category_Desc'] +\
	['Post_Date'] + ['Transaction_Date'] + ['Transaction_Type'] +['Merchant_Country'])
    ...
    for i in range(10):
		...
		row.append(date1)
		row.append(date2)
		row.extend([random.choice(Transaction_Type),random.choice(Country)])
		writer.writerow(row)
